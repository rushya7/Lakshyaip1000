...
const handleDownload = () => {
  ...
  doc.save("NDA_Form.pdf");
    ...
    return (
        <>
            <Header />
            <PageHeader title={title} curPage={"NDA"} />

            <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-sky-100 to-indigo-200 p-6">
                <div className="w-full max-w-5xl bg-white/40 backdrop-blur-xl shadow-2xl rounded-2xl p-10 border border-white/50">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input
                                    ...
                                    type="text"
                                    className="w-full mt-2 p-3 rounded-xl border border-gray-300 shadow-sm focus:ring-2 focus:ring-indigo-400 focus:outline-none"
                                />
                                {errors.firstName && (
                        ...
                        <div>
                            ...
                            <div className="terms-box bg-white/60 border border-gray-300 rounded-xl p-5 h-[70vh] overflow-y-auto shadow-inner">
                                {/* Put your NDA content here */}
                        ...
                        <div className="text-center my-6">
                            <button
                                ...
                                className="px-6 py-2 rounded-xl bg-green-600 text-white font-semibold shadow-lg hover:bg-green-700 hover:scale-105 transition transform duration-200 ease-in-out"
                            >
                                Download NDA
                            </button>
                        </div>
                        ...
                        <div className="text-center">
                            <button
                                type="submit"
                                className="px-8 py-3 rounded-xl bg-indigo-600 text-white font-semibold shadow-lg hover:bg-indigo-700 hover:scale-105 transition transform duration-200 ease-in-out"
                            >
                                Submit
                            </button>
